...
--expression_file $RESULTS/with_sc_blood38/$fn/abcd_pred_adtrain_male.txt \
--input_phenos_file $DATA/abcd_ad_train_male.txt \
--input_phenos_column anxdep_t \
--covariates_file $DATA/abcd_ad_train_male.txt \
--covariates genetic_pc_1	genetic_pc_2	genetic_pc_3	genetic_pc_4	genetic_pc_5	genetic_pc_6	\
genetic_pc_7	genetic_pc_8	genetic_pc_9	genetic_pc_10 age site22 site02 site03 site04 site05 \
site06 site07 site08 site09 site10 site11 site12 site13 site14 site15 site16 site17 site18 site19 site20 site21 \
--output $RESULTS/with_sc_blood38/$fn/abcd_anxdep_assoc_covars_male.txt \
--verbosity 9 \
--throw

python3 $METAXCAN/PrediXcanAssociation.py \
--expression_file $RESULTS/with_sc_blood38/$fn/abcd_pred_wdtrain_male.txt \
--input_phenos_file $DATA/abcd_wd_train_male.txt \
--input_phenos_column withdep_t \
--covariates_file $DATA/abcd_ad_train_male.txt \
--covariates genetic_pc_1	genetic_pc_2	genetic_pc_3	genetic_pc_4	genetic_pc_5	genetic_pc_6	\
genetic_pc_7	genetic_pc_8	genetic_pc_9	genetic_pc_10 age site22 site02 site03 site04 site05 \
site06 site07 site08 site09 site10 site11 site12 site13 site14 site15 site16 site17 site18 site19 site20 site21 \
--output $RESULTS/with_sc_blood38/$fn/abcd_withdep_assoc_covars_male.txt \
--verbosity 9 \
--throw

python3 $METAXCAN/PrediXcanAssociation.py \
--expression_file $RESULTS/with_sc_blood38/$fn/abcd_pred_adtrain_female.txt \
--input_phenos_file $DATA/abcd_ad_train_female.txt \
--input_phenos_column anxdep_t \
--covariates_file $DATA/abcd_ad_train_female.txt \
--covariates genetic_pc_1	genetic_pc_2	genetic_pc_3	genetic_pc_4	genetic_pc_5	genetic_pc_6	\
genetic_pc_7	genetic_pc_8	genetic_pc_9	genetic_pc_10 age site22 site02 site03 site04 site05 \
site06 site07 site08 site09 site10 site11 site12 site13 site14 site15 site16 site17 site18 site19 site20 site21 \
--output $RESULTS/with_sc_blood38/$fn/abcd_anxdep_assoc_covars_female.txt \
--verbosity 9 \
--throw

python3 $METAXCAN/PrediXcanAssociation.py \
--expression_file $RESULTS/with_sc_blood38/$fn/abcd_pred_wdtrain_female.txt \
--input_phenos_file $DATA/abcd_wd_train_female.txt \
--input_phenos_column withdep_t \
--covariates_file $DATA/abcd_ad_train_female.txt \
--covariates genetic_pc_1	genetic_pc_2	genetic_pc_3	genetic_pc_4	genetic_pc_5	genetic_pc_6	\
genetic_pc_7	genetic_pc_8	genetic_pc_9	genetic_pc_10 age site22 site02 site03 site04 site05 \
site06 site07 site08 site09 site10 site11 site12 site13 site14 site15 site16 site17 site18 site19 site20 site21 \
--output $RESULTS/with_sc_blood38/$fn/abcd_withdep_assoc_covars_female.txt \
--verbosity 9 \
--throw
