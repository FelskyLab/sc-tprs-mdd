...
library(readxl)
cnames <- as.list(read_excel("sc-tprs-mdd/Wittenberg2020.xlsx", sheet = "S9 SMD Meta-Analysis", 
                     range = cell_rows(1)))
deg <- read_excel("sc-tprs-mdd/Wittenberg2020.xlsx", sheet = "S9 SMD Meta-Analysis", 
