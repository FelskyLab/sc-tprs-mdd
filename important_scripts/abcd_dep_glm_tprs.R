...
# goal: log and gamma regs for wittenberg tPRSs
# next: a lot of insig -> try TWAS based tPRSs
...
# how do tPRS distr look between high low cbcl scores==================
library(ggbeeswarm)
library(viridis)
...
# plot for logistic reg sigmoid shape======================
# very flat
